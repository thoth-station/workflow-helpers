...
DESCRIPTION = os.getenv("DESCRIPTION ", f"a deployment to {ENVIRONMENT} just happened")
...
if __name__ == "__main__":
    ...
    deployment_url = f"/repos/{REPO_FULL_NAME}/deployments"
    ...
    if resp.status != 201:
        ...
        _LOGGER.info(
            f"GitHub deployment created for {REPO_FULL_NAME}: "
